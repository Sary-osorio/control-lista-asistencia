<div>
    <div class=" flex justify-between items-center">
        <h1 class="">{{ __('Listado de miembros') }}</h1>
                            ...
                            {{-- @if ($miembro['estado'])
                                <button>
                                    <svg width="24" height="24" viewBox="0 0 100 100"
                                        ...
                                        <path d="M30 52 L45 67 L70 40" stroke="white" stroke-width="10"
                            ...
                            @else
                                <button>
                                    <svg width="24" height="24" viewBox="0 0 100 100"
                                        ...
                                        <path d="M35 35 L65 65 M65 35 L35 65" stroke="white" stroke-width="10"
            ...
            <div class="p-4">
                ...
                <form wire:submit.prevent="storeMiembro">
                    ...
                    <div class="py-3">
                        ...
                        <x-text-input type="date" id="fechaNac" name="fechaNac" class="block mt-1 w-full"
                    ...
                    <div class="py-3">
                        ...
                        <select
                            ...
                            wire:model.defer="grupo" name="grupo" id="grupo">
